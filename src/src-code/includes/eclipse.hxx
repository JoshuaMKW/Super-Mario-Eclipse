...
public:
    ...
    struct
    {
        ...
        RGBA<u8> mGreenYoshi;       //0x0060
        RGBA<u8> mOrangeYoshi;      //0x0064
        RGBA<u8> mPurpleYoshi;      //0x0068
        RGBA<u8> mPinkYoshi;        //0x006C
        float mMaxVSpdStartFlutter; //0x0070
        float mFlutterAcceleration; //0x0074
