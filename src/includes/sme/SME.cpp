...
SME_PATCH_BL(SME_PORT_REGION(0x802A744C, 0, 0, 0), moduleLoad);
  ...
  SME_PATCH_B(SME_PORT_REGION(0x802A8B30, 0, 0, 0),
  ...
  SME_PATCH_BL(SME_PORT_REGION(0x800678C4, 0, 0, 0),
               Patch::Fludd::sprayGoopMap);
  SME_PATCH_BL(SME_PORT_REGION(0x801A3ED0, 0, 0, 0),
               Patch::Fludd::sprayGoopMap);
  SME_PATCH_BL(SME_PORT_REGION(0x801B42D8, 0, 0, 0),
               Patch::Fludd::sprayGoopMap);
  SME_PATCH_BL(SME_PORT_REGION(0x8024E710, 0, 0, 0),
               Patch::Fludd::sprayGoopMap);
  SME_PATCH_BL(SME_PORT_REGION(0x8027F7DC, 0, 0, 0),
               Patch::Fludd::sprayGoopMap);
  SME_PATCH_BL(SME_PORT_REGION(0x8027F94C, 0, 0, 0),
               Patch::Fludd::sprayGoopMap);
  SME_PATCH_BL(SME_PORT_REGION(0x800FED3C, 0, 0, 0),
  ...
  SME_PATCH_BL(SME_PORT_REGION(0x802983F0, 0, 0, 0),
               Patch::Init::initMusicTrack);
  SME_PATCH_BL(SME_PORT_REGION(0x80298420, 0, 0, 0),
               Patch::Init::initMusicTrack);
  SME_WRITE_32(SME_PORT_REGION(0x80276C90, 0, 0, 0), 0x60000000);
  SME_PATCH_BL(SME_PORT_REGION(0x80276C94, 0, 0, 0),
  ...
  SME_PATCH_BL(SME_PORT_REGION(0x802995BC, 0, 0, 0),
