...
static void initCustomFunctions(TSpcBinary *spcBinary, const char *symbol,
                                u32 address) {
  ...
  BIND_SYMBOL(spcBinary, "isMultiplayerActive", Spc::isMultiplayerActive);
  BIND_SYMBOL(spcBinary, "isFreePlayActive", Spc::isFreePlayActive);
  BIND_SYMBOL(spcBinary, "isMirrorModeActive", Spc::isMirrorModeActive);
  BIND_SYMBOL(spcBinary, "isCompletionRewardActive",
              Spc::isCompletionRewardActive);
