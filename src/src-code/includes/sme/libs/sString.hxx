...
public:
    ...
    */
    ...
    static s32 stringToInt(const char *str, size_t base = 10) { return strtol(str, nullptr, base); };
    ...
    constexpr size_t compare(const char *str);
    constexpr size_t compare(size_t pos, size_t len, const char *str);
    constexpr size_t compare(size_t pos, size_t len, const char *str, size_t subpos, size_t sublen);
    size_t erase(size_t pos, size_t len = String::npos);
    constexpr size_t find(const char *str, size_t startPos = 0);
    constexpr size_t find(const char chr, size_t startPos = 0);
    constexpr size_t findAny(const char list[], size_t startPos = 0);
    void insert(size_t pos, const char *str);
    size_t replace(size_t pos, size_t len, const char *newstr);
    size_t replace(size_t pos, size_t len, const char newstr);
    size_t replace(const char *oldstr, const char *newstr, size_t replaceIndex = 0);
