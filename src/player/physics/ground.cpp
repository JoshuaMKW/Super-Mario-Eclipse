...
SME_PATCH_BL(SME_PORT_REGION(0x8025B8C0, 0x8025364C, 0, 0), checkGroundSpeedLimit);
...
SME_PATCH_BL(SME_PORT_REGION(0x8024E288, 0x80246014, 0, 0), checkGraffitiAffected);