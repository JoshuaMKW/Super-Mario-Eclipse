...
void Spc::isMultiplayerActive(TSpcInterp *interp, u32 argc) {
  ...
  Spc::Stack::pushItem(interp, static_cast<u32>(SME::TGlobals::sGlobals.isMultiplayerActive()), Spc::ValueType::INT); // Return a value
}
...
void Spc::isFreePlayActive(TSpcInterp *interp, u32 argc) {
  ...
  Spc::Stack::pushItem(interp, static_cast<u32>(SME::TGlobals::sGlobals.isFreePlayMode()), Spc::ValueType::INT); // Return a value
}
...
void Spc::isCompletionRewardActive(TSpcInterp *interp, u32 argc) {
  ...
  Spc::Stack::pushItem(interp, static_cast<u32>(SME::TGlobals::sGlobals.isCompletionRewarded()), Spc::ValueType::INT); // Return a value
}
...
void Spc::getActivePlayers(TSpcInterp *interp, u32 argc) {
  ...
  Spc::Stack::pushItem(interp, static_cast<u32>(SME::TGlobals::sGlobals.getActivePlayers()), Spc::ValueType::INT); // Return a value
}
...
void Spc::getMaxPlayers(TSpcInterp *interp, u32 argc) {
  ...
  Spc::Stack::pushItem(interp, static_cast<u32>(SME::TGlobals::sGlobals.getMaxPlayers()), Spc::ValueType::INT); // Return a value
}