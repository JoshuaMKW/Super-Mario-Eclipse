...
BETTER_SMS_FOR_CALLBACK void initializeShineBlueTracker(TMarDirector *director) {
    ...
    case TGameSequence::AREA_AIRPORT: {
        ...
        s_stage_blues_collected += TFlagManager::smInstance->getFlag(0x10078);
...
BETTER_SMS_FOR_CALLBACK void updateShineBlueTracker(TMarDirector *director) {
    ...
    snprintf(s_shine_text_buffer, 64, "Shine Sprites: %lu/%lu", s_stage_shines_collected, s_stage_shines_max);
    snprintf(s_blue_text_buffer, 64, "Blue Coins: %lu/%lu", s_stage_blues_collected, s_stage_blues_max);
}
