...
SME_PATCH_BL(SME_PORT_REGION(0x80213314, 0x8020b1f4, 0, 0), Patch::Mario::scaleNPCTalkRadius);
...
// SME_PATCH_BL(SME_PORT_REGION(0x8024CC2C, 0x802449b4, 0, 0), Patch::Mario::checkJumpSpeedMulti);
// SME_WRITE_32(SME_PORT_REGION(0x8024CC30, 0x802449b8, 0, 0), 0x57C5043E);
