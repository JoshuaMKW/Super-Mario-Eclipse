...
KURIBO_MODULE_BEGIN("Eclipse", "JoshuaMK",
  ...
  KURIBO_PATCH_B(SME_PORT_REGION(0x802A8B30, 0, 0, 0),
  ...
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8027C6A4, 0, 0, 0),
                  Patch::CKit::manageLightSize);
  kWrite32(SME_PORT_REGION(0x8027C6A8, 0, 0, 0), 0x28030001);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80153DE8, 0, 0, 0),
                  Patch::CKit::formatTalkMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80153E1C, 0, 0, 0),
                  Patch::CKit::formatTalkMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024D3A8, 0, 0, 0),
                  Patch::CKit::realTimeCustomAttrsHandler);

  // camera.cpp
  KURIBO_PATCH_B(SME_PORT_REGION(0x80027548, 0, 0, 0),
                 Patch::Camera::modifyCameraRangeToSize);

  // CheatCode.cpp
  KURIBO_PATCH_B(SME_PORT_REGION(0x80295B6C, 0, 0, 0),
                 Patch::Cheat::handleDebugCheat);

  // collision.cpp
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80258334, 0, 0, 0),
                  Patch::Collision::checkIsGlideBounce);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80264CFC, 0, 0, 0),
                  Patch::Collision::checkIsGlideBounce);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024C558, 0, 0, 0),
                  Patch::Collision::checkIsRestoreTypeNoFallDamage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802500B8, 0, 0, 0),
                  Patch::Collision::updateCollisionContext);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80250CA0, 0, 0, 0),
                  Patch::Collision::masterGroundCollisionHandler);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8025059C, 0, 0, 0),
                  Patch::Collision::masterAllCollisionHandler);

  // file_flags.cpp
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802B1794, 0, 0, 0),
  ...
  kWrite32(SME_PORT_REGION(0x803DCA02, 0, 0, 0),
           0x00300000 | TMarioAnimeData::FLUDD::FLUDD_ENABLED);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8014206C, 0, 0, 0),
                  Patch::Fludd::hasWaterCardOpen);
  kWrite32(SME_PORT_REGION(0x80142070, 0, 0, 0), 0x28030000);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80283058, 0, 0, 0),
                  Patch::Fludd::canCollectFluddItem);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x800678C4, 0, 0, 0),
                  Patch::Fludd::sprayGoopMapWrapGlobalMar);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x801A3ED0, 0, 0, 0),
                  Patch::Fludd::sprayGoopMapWrapGlobalMar);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x801B42D8, 0, 0, 0),
                  Patch::Fludd::sprayGoopMapWrapGlobalMar);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024E710, 0, 0, 0),
                  Patch::Fludd::sprayGoopMapWrapMar30);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8027F7DC, 0, 0, 0),
                  Patch::Fludd::sprayGoopMapWrapGlobalMar);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8027F94C, 0, 0, 0),
                  Patch::Fludd::sprayGoopMapWrapGlobalMar);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x800FED3C, 0, 0, 0),
                  Patch::Fludd::canCleanSeals);
  kWrite32(SME_PORT_REGION(0x800FED40, 0, 0, 0), 0x2C030000);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024D53C, 0, 0, 0),
                  Patch::Fludd::bindFluddtojoint);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024E548, 0, 0, 0),
                  Patch::Fludd::checkExecWaterGun);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8026C370, 0, 0, 0),
                  Patch::Fludd::killTriggerNozzle);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8026C018, 0, 0, 0),
                  Patch::Fludd::spamHoverWrapper);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80262580, 0, 0, 0),
                  Patch::Fludd::checkAirNozzle);
  kWrite32(SME_PORT_REGION(0x80262584, 0, 0, 0), 0x2C030000);

  // fruit.cpp
  KURIBO_PATCH_BL(SME_PORT_REGION(0x801E542C, 0, 0, 0),
  ...
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8023F964, 0, 0, 0),
                  Patch::Fruit::chooseGrabDistancing);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8023F9DC, 0, 0, 0),
                  Patch::Fruit::isGrabWaitOver);

  // init_mods.cpp
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80005328, 0, 0, 0),
                  Patch::Init::initCodeProtection);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802A750C, 0, 0, 0),
                  Patch::Init::createGlobalHeaps);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802A7140, 0, 0, 0),
                  Patch::Init::setupMarioDatas);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802A716C, 0, 0, 0),
                  Patch::Init::initFirstModel);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802998B4, 0, 0, 0),
                  Patch::Init::initFileMods);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80280180, 0, 0, 0),
                  Patch::Init::initShineShadow);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802B7A4C, 0, 0, 0),
                  Patch::Init::initSoundBank);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802983F0, 0, 0, 0),
                  Patch::Init::initMusicTrack);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80298420, 0, 0, 0),
                  Patch::Init::initMusicTrack);
  kWrite32(SME_PORT_REGION(0x80276C90, 0, 0, 0), 0x60000000);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80276C94, 0, 0, 0),
                  Patch::Init::fromMarioInit);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x800397DC, 0, 0, 0),
                  Patch::Init::fromShadowMarioInit);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80271580, 0, 0, 0), Patch::Init::initYoshi);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8029CCB0, 0, 0, 0),
                  Patch::Init::initCardColors);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802B8B20, 0, 0, 0),
                  Patch::Init::initCollisionWarpLinks);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802B57E4, 0, 0, 0),
                  Patch::Init::createUIHeap);

  // mario.cpp
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802320E0, 0, 0, 0), mario_shadowCrashPatch);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802500B8, 0, 0, 0),
                  Patch::Mario::updateContexts);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8029A87C, 0, 0, 0),
                  Patch::Mario::carryOrTalkNPC);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802815F0, 0, 0, 0),
                  Patch::Mario::canGrabAtNPC);
  kWrite32(SME_PORT_REGION(0x802815F4, 0, 0, 0), 0x2C030000);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80207430, 0, 0, 0),
                  Patch::Mario::canCarryNPC);
  kWrite32(SME_PORT_REGION(0x80207434, 0, 0, 0), 0x2C030000);

  // shine.cpp
  KURIBO_PATCH_BL(SME_PORT_REGION(0x801BD664, 0, 0, 0),
                  Patch::Shine::manageShineVanish);
  kWrite32(SME_PORT_REGION(0x801BD668, 0, 0, 0), 0x48000568);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802413E0, 0, 0, 0),
                  Patch::Shine::isKillEnemiesShine);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802995BC, 0, 0, 0),
                  Patch::Shine::checkBootOut);
  kWrite32(SME_PORT_REGION(0x80297BE8, 0, 0, 0), 0x60848200);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80293B10, 0, 0, 0),
                  Patch::Shine::extendShineIDLogic);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x801BCC98, 0, 0, 0),
  ...
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802946D4, 0, 0, 0),
                  Patch::Shine::shineSetClamper);
  kWrite32(SME_PORT_REGION(0x80294744, 0, 0, 0), 0x60000000);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8029474C, 0, 0, 0),
  ...
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802999D8, 0, 0, 0),
  ...
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024D68C, 0, 0, 0),
                  Patch::Yoshi::isYoshiMaintainFluddModel);
  kWrite32(SME_PORT_REGION(0x8024D690, 0, 0, 0), 0x2C030000);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024F240, 0, 0, 0),
                  Patch::Yoshi::maybeYoshiDrown);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x802810F8, 0, 0, 0),
                  Patch::Yoshi::canMountYoshi);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80281148, 0, 0, 0),
                  Patch::Yoshi::getYoshiYPos_);
  kWrite32(SME_PORT_REGION(0x802810FC, 0, 0, 0), 0x2C030000);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8026E810, 0, 0, 0),
                  Patch::Yoshi::fixYoshiJuiceDecrement);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024E58C, 0, 0, 0),
                  Patch::Yoshi::canYoshiSpray);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80273198, 0, 0, 0),
                  Patch::Yoshi::calcYoshiSwimVelocity);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80270078, 0, 0, 0),
  ...
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024E788, 0, 0, 0),
                  Patch::Yoshi::isYoshiValidDrip);
  KURIBO_PATCH_B(SME_PORT_REGION(0x801BC128, 0, 0, 0),
                 Patch::Yoshi::initFreeEggCard);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x801BC380, 0, 0, 0),
                  Patch::Yoshi::checkFreeEggCard);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8028121C, 0, 0, 0),
                  Patch::Yoshi::saveNozzles);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8024EC18, 0, 0, 0),
  ...
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015B2C0, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015B2F8, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015B5BC, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015B5E4, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015B638, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015B660, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015BCB8, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015BCE0, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015BE24, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015BE4C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015BE9C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015BEC4, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015C508, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015D194, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015D1CC, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015DEFC, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015DF34, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015E34C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015E374, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015E3C8, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015E3F0, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015F970, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8015F9A8, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80161320, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80161358, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016889C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x801688D4, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80169224, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016925C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016950C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80169534, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016958C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x801695B4, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80169ACC, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x80169B04, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016A02C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016A064, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016A3D0, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016A3F8, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016A44C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016A474, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016B19C, 0, 0, 0),
                  Patch::Card::formatCardMessage);
  KURIBO_PATCH_BL(SME_PORT_REGION(0x8016B1D4, 0, 0, 0),
                  Patch::Card::formatCardMessage);
