...
namespace Yoshi {
    ...
    bool isMounted(TMario *player) { return player->mYoshi->mState == TYoshi::MOUNTED; }
    ...
    bool isGreenYoshiMounted(TMario *player) { return isGreenYoshiMounted(player->mYoshi); }
