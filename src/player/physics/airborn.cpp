...
SME_PATCH_BL(SME_PORT_REGION(0x80256678, 0x8024E404, 0, 0),             checkYSpdForTerminalVelocity);
...
SME_PATCH_BL(SME_PORT_REGION(0x8024CC6C, 0x802449F8, 0, 0), checkJumpSpeedLimit);
...
SME_PATCH_BL(SME_PORT_REGION(0x8024CC2C, 0x802449B8, 0, 0), checkJumpSpeedMulti);
SME_WRITE_32(SME_PORT_REGION(0x8024CC30, 0x802449BC, 0, 0), 0x57C5043E);

#if SME_DYNAMIC_FALL_DAMAGE
