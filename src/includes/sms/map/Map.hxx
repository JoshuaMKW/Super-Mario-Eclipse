...
public:
  ...
  f32 checkGroundIgnoreWaterSurface(const JGeometry::TVec3<f32> &pos, TBGCheckData **out) const;
  ...
  TBGCheckData *intersectLine(const JGeometry::TVec3<f32> &a, const JGeometry::TVec3<f32> &b, bool, JGeometry::TVec3<f32> *);
