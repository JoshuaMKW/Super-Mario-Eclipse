...
SME_PATCH_BL(SME_PORT_REGION(0x8026EBFC, 0, 0, 0), isYoshiDie);
SME_WRITE_32(SME_PORT_REGION(0x8026EC00, 0, 0, 0), 0x2C030000);
SME_WRITE_32(SME_PORT_REGION(0x8026EC04, 0, 0, 0), 0x4182041C);

SME_PATCH_BL(SME_PORT_REGION(0x8026F218, 0, 0, 0), isYoshiDie);
...
SME_PATCH_BL(SME_PORT_REGION(0x802810F8, 0, 0, 0), canMountYoshi);
...
SME_PATCH_BL(SME_PORT_REGION(0x80281148, 0, 0, 0), getYoshiYPos);
...
SME_PATCH_BL(SME_PORT_REGION(0x80273198, 0, 0, 0), calcYoshiSwimVelocity);
...
SME_PATCH_BL(SME_PORT_REGION(0x80270078, 0, 0, 0), isYoshiWaterFlutter);
